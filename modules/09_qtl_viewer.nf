...
"
    ...
    # TEMPORARILY COMMENTED OUT DUE TO NEXTFLOW ESCAPING ISSUES
    # TODO: Fix bash variable escaping
    debug_script <- "#!/bin/bash

    echo 'QTL Viewer Debug Script - Under Construction'
    echo 'This script is being updated to fix escaping issues'
    "
